...
* :ref:`gs` shows how to install and gives an introduction to using Ocean tools.

* :ref:`concepts_sdk` describes Ocean concepts in depth and provides short definitions of terminology.
...
.. list-table:: Ocean Software
   ...
   * - :doc:`dwave-cloud-client <doc_cloud/sdk_index>` (`repo <https://github.com/dwavesystems/dwave-cloud-client>`_)
