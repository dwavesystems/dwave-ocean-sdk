...
All open source code in Ocean is released under the Apache-2.0 copyright license.
Contributors to Ocean license their code under the same license when it is
included into Ocean's version control repository. That means contributors must
own the copyright of any code submitted to Ocean or must include the Apache-2.0
