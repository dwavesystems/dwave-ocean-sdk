...
Acknowledgements
----------------
We thank the SymPy and SciPy developers for their AI policies, upon which this document is largely
based.

- https://github.com/scipy/scipy/blob/193a95e/doc/source/dev/conduct/ai_policy.rst
- https://github.com/sympy/sympy/blob/0788103/doc/src/contributing/ai-generated-code-policy.rst

Responsibility
--------------

You are responsible for any code you submit to D-Wave's repositories, regardless
...
submit code that meets D-Wave's standards. We will reject pull requests that we
...
All open-source code in the Ocean SDK is released under the Apache-2.0 copyright license.
Contributors to Ocean software license their code under the same license when it is
included into the Ocean SDK's version control repository. That means contributors must
own the copyright of any code submitted to the Ocean SDK or must include the Apache-2.0
compatible open source license(s) associated with the submitted code
